<template>
	<view>
		<view class="body_gong" v-for="(o, index) in list" :key="index" @click="xq(o.id)">
			<view class="title">{{ o.title }}
				<score-item :score="o.score" :itemid="o.id" :readable="false"></score-item>
			</view>
			...
			<view class="time">
				<u-icon :label="o.ctime" size="20" labelSize="14" labelColor="#747474"
					name="https://shopimges.oss-cn-hangzhou.aliyuncs.com/wuye/time.png"></u-icon>
			</view>
		</view>
		<view v-if="list.length == 0">
			<u-empty marginTop="100" text="暂无数据" mode="message"
