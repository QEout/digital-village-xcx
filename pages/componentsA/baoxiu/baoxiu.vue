<template>
	<view class="bianjia u-demo-block__content">
		...
		<u--form labelPosition="left" :model="model" ref="form1">
			...
			<u-form-item label="报修内容:" borderBottom ref="item1" labelWidth="100" >
				<u--textarea placeholder="请具体描述报修情况" v-model="model.details" count maxlength="200"></u--textarea>
			</u-form-item>
		...
		<u-action-sheet :show="showSex" :actions="radiolist2" title="选择" @close="showSex = false"
			@select="sexSelect">
		</u-action-sheet>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			tijiao(){
				...
				uni.$u.http.post('Repair/edit', this.model)
				.then(res => {
					// this.list=res.data;
					console.log(res)
					// setTimeout(() => {
