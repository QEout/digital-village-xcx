<template>
	<view class="bianjia u-demo-block__content">
		...
		<u--form labelPosition="left" :model="model" ref="form1">
			...
			<u-form-item label="求助类型:" borderBottom ref="item1" labelWidth="100">
			...
			<u-form-item label="户号:" borderBottom ref="item1" labelWidth="100" 
				@click="showSex = true;">
				<u--input v-model="model.type" disabled disabledColor="#ffffff" placeholder="请选择户号" border="none">
				</u--input>
		...
		<u-action-sheet :show="showSex" :actions="radiolist2" title="选择户号" @close="showSex = false"
			@select="sexSelect">
		</u-action-sheet>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			tijiao(){
				...
				uni.$u.http.post('SeekHelp/edit', this.model)
				.then(res => {
					// this.list=res.data;
					console.log(res)
					// setTimeout(() => {
